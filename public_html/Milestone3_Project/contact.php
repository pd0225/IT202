...
<div>
    <h2 style="text-align:center;color:black;">Contact Us</h2>
        ...
        <p style="text-align: center"><span class="heading">Email: </span>psbbranch.in@psb.co</p>
        ...
        <p style="text-align: center"><span class="heading"> Phone: +61 0245 6789</span></p>
        <p style="text-align: center"><span class="heading"> Email: psbbranch.au@psb.co</span></p>
        ...
        <p style="text-align: center"><span class="heading">Email: </span>psbbranch.ca@psb.co</p>
